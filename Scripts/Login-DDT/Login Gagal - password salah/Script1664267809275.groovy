...
WebUI.delay(2)
if (WebUI.verifyElementPresent(findTestObject('error messages/password is incorrect'), 5, FailureHandling.OPTIONAL)) { KeywordUtil.markPassed("Success") } else { }
if (WebUI.verifyElementPresent(findTestObject('error messages/password must be at least 8 chars'), 5, FailureHandling.OPTIONAL)) { KeywordUtil.markPassed("Success") } else { }
WebUI.delay(2)
