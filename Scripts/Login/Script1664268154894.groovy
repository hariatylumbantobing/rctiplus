...
WebUI.setText(findTestObject('Login page/input_Email or Phone Number_username'), 'listform@gmail.com')

WebUI.setText(findTestObject('Login page/input_Password_password'), 'dududu98')

WebUI.click(findTestObject('Login Page/button_Log In'))

WebUI.delay(2)

WebUI.verifyElementPresent(findTestObject('Homepage/logo_rplus_di_homepage'), 10)
